...
function switchToDashboard(dashboard) {
    ...
    if (manualSection) manualSection.classList.remove('active');
    if (whatsappSection) whatsappSection.classList.remove('active');
    if (violationsSection) violationsSection.classList.remove('active');
    ...
    if (createViolationBtn) createViolationBtn.style.display = 'none';
    if (createWorkOrderBtn) createWorkOrderBtn.style.display = 'none';
    if (switchToTicketsBtn) switchToTicketsBtn.style.display = 'none';
    ...
    switch (dashboard) {
        case 'manual':
            ...
            if (title) title.textContent = 'Ticket Dashboard';
            if (createTicketBtn) createTicketBtn.style.display = 'flex';
            loadTickets();
            break;

        case 'whatsapp':
            if (whatsappSection) whatsappSection.classList.add('active');
            if (title) title.textContent = 'WhatsApp Tickets';
            if (switchToTicketsBtn) switchToTicketsBtn.style.display = 'flex';
            break;

        case 'violations':
            if (violationsSection) violationsSection.classList.add('active');
            if (title) title.textContent = 'Violations Management';
            if (createViolationBtn) createViolationBtn.style.display = 'flex';
            if (switchToTicketsBtn) switchToTicketsBtn.style.display = 'flex';
            if (typeof loadViolations === 'function') loadViolations();
            break;

        case 'workorders':
            if (workOrdersSection) workOrdersSection.classList.add('active');
            if (title) title.textContent = 'Work Orders';
            if (createWorkOrderBtn) createWorkOrderBtn.style.display = 'flex';
            if (switchToTicketsBtn) switchToTicketsBtn.style.display = 'flex';
